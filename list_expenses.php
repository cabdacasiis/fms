  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
     ...
     <section class="section dashboard">
        <table class="table datatable" style="max-width: 100% ;background-color: white;">
          <thead>
          <th>ID</th>
            <th>Description</th>
            <th>Number/Account</th>
            <th>Trans Date</th>
            <th>Company/custumer</th>
            <th>Amout</th>
            <th>Type</th>
           <th>Action</th>
</thead>
        <?php
              ...
              $sql = "SELECT * FROM transaction WHERE trans_type = 'expense'";
